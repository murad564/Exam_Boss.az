...
namespace SearchingSYS
{
    class Employee : User
    {
        ...
        public void AnnouncesForCV(List<Employers> employers)
        {
            int i = 1;
            ...
            if (i == 1) Tool.ShowMessage("There is not any announcement that corresponds to your CV ", ConsoleColor.Red);
        }
        public void AnnouncesByCategory(List<Employers> employers)
        {
        ...
        option:
            ...
            {
                Tool.ShowMessage("Invalid imput, try again", ConsoleColor.Red);
                goto option;
            }
            bool check = false;
            switch (option)
            ...
            if (!check) Tool.ShowMessage("There is not any announcement that corresponds to choice ", ConsoleColor.Red);
        }
    }
}